...
export default function AdminUpdates() {
  ...
  const updatesList = [
    ...
    {
      id: 'supplier-returns-log',
      badge: 'إدارة الموردين والمخزون',
      badgeColor: 'amber',
      title: 'إصلاح ارجاع المنتجات للمورد وتدشين سجل المرتجعات التفصيلي',
      date: 'سبتمبر 2026',
      summary: 'إصلاح خطأ حفظ مرتجع المورد في سجل المخزون، وإضافة تبويب سجل المرتجعات مع أسباب الإرجاع وطباعة إشعار رسمي.',
      before: {
        title: 'قبل التعديل',
        items: [
          'كان الإرجاع يخصم الكمية من المخزن لكن يفشل الطلب في الحفظ (خطأ Supplier Return في سجل المخزون).',
          'عدم تسجيل حركة المرتجع في كشف حساب المورد أو تسوية الخزينة بشكل مكتمل.',
          'غياب سجل مخصص يعرض تاريخ وسبب إرجاع كل صنف للمورد.'
        ],
        status: 'فشل حفظ المرتجع وتضارب المخزون',
        statusColor: 'text-rose-600 bg-rose-50 border-rose-200'
      },
      after: {
        title: 'بعد التعديل',
        items: [
          'إصلاح التحقق وحفظ المرتجع وتعديل رصيد المورد والخزينة بدقة تامة وبدون أخطاء.',
          'إضافة تبويب سجل المرتجعات في صفحة كل مورد بالتاريخ والوقت والأسباب والكميات والأسعار.',
          'إمكانية طباعة إشعار مرتجع بضاعة رسمي وتوقيع الاستلام، مع إعادة القطع للمخزن تلقائياً عند الإلغاء.'
        ],
        status: 'سجل متكامل وموثق 100%',
        statusColor: 'text-emerald-700 bg-emerald-50 border-emerald-200'
      },
      formula: 'مرتجع المورد = خصم من المخزن + تسجيل في كشف الحساب + إشعار رسمي موثق بالأسباب'
    },
    {
      id: 'supplier-billing-season-pos',
      badge: 'الموردين والباركود',
      badgeColor: 'emerald',
      title: 'ربط فواتير بضاعة الموردين وتفعيل باركود المنتجات الموسمية',
      date: 'سبتمبر 2026',
      summary: 'تطابق مرن لأسماء الموردين لمنع إنشاء موردين مكررين برقم جديد، وإتاحة قراءة باركود الأصناف الصيفية/المؤرشفة موسمياً بالكاشير فوراً مع الحفاظ على أرقام الموديلات.',
      before: {
        title: 'قبل التعديل',
        items: [
          'أي اختلاف طفيف في مسافات أو همزات اسم المورد كان ينشئ سجلاً مكرراً برقم ID جديد، فتُصرف الفاتورة من الخزنة دون أن تظهر في كشف حساب المورد الأصلي أو ينزل رصيده.',
          'المنتجات المصنفة كموسم صيفي كانت تُؤرشف تلقائياً وتختفي من بحث الكاشير وتفشل قراءة الباركود بالسكانر.',
          'دالة تنظيف أسماء المنتجات كانت تحذف أرقام الموديلات المنتهية بأرقام (مثل 148).'
        ],
        status: 'تشتت حسابات الموردين وحجب الباركود',
        statusColor: 'text-rose-600 bg-rose-50 border-rose-200'
      },
      after: {
        title: 'بعد التعديل',
        items: [
          'مطابقة ذكية لأسماء الموردين بتجاهل الفروق الكتابية وربط المعاملات برقم المورد المختار مباشرة وتحديث كشف حسابه ورصيده بدقة.',
          'نظام البحث وقراءة الباركود بالكاشير يستثني شرط الأرشفة الموسمية، ويفعل الصنف فوراً عند مسح الباركود دون المساس بنظام وتصميم الباركود إطلاقاً.',
          'الحفاظ التام على أرقام الموديلات في أسماء الأصناف ومطابقة الخصومات.'
        ],
        status: 'ربط سليم وجاهزية تامة للكاشير',
        statusColor: 'text-emerald-700 bg-emerald-50 border-emerald-200'
      },
      formula: 'فاتورة المورد = ربط مباشر بالـ ID + كشف حساب ورصيد سليم + باركود جاهز للبيع'
    }
  ];
